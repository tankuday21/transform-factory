...
import { FiUpload, FiFile, FiZoomOut, FiCheck, FiTrash2 } from 'react-icons/fi'
...
export default function CompressPDFPage() {
  ...
  const processPDF = async () => {
    ...
    try {
      ...
      const newSize = parseInt(response.headers.get('X-New-Size') || '0', 10)
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <h2 className="text-xl font-semibold mb-4">2. Compression Options</h2>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">Lower quality, smaller file</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">Balanced compression</div>
                </button>
                ...
                >
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">Better quality, larger file</div>
                </button>
              </div>
            </div>
            ...
            <div className="mt-6 bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
              ...
              <p className="text-sm text-yellow-700 dark:text-yellow-400">
                Compression reduces file size by optimizing the structure of the PDF. The compression level determines the balance between file size and quality. Results may vary depending on the content of your PDF.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-xl p-6 animate-fadeIn">
          ...
          <div className="mb-6">
            <div className="flex justify-between mb-2">
              <span className="text-sm text-green-700 dark:text-green-300">Original Size:</span>
              <span className="text-sm font-medium text-green-800 dark:text-green-200">{formatBytes(compressionResult.originalSize)}</span>
            </div>
            <div className="flex justify-between mb-2">
              <span className="text-sm text-green-700 dark:text-green-300">Compressed Size:</span>
              <span className="text-sm font-medium text-green-800 dark:text-green-200">{formatBytes(compressionResult.newSize)}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-sm text-green-700 dark:text-green-300">Reduction:</span>
              <span className="text-sm font-medium text-green-800 dark:text-green-200">
                {compressionResult.ratio > 0 
                  ? `${compressionResult.ratio}% smaller` 
            ...
            <div className="mt-4 h-2 bg-green-200 dark:bg-green-900 rounded-full overflow-hidden">
              <div 
                ...
                style={{ width: `${Math.min(100, compressionResult.ratio)}%` }}
              ></div>
            </div>
          </div>
